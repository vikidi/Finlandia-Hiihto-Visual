...
<title>Finlandia Hiihto: Release Notes</title>
...
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md1009"></a>
Development</h1>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.7.3...master">Commits</a></p>
<h1><a class="anchor" id="autotoc_md1010"></a>
v4.7.3 - February 5th, 2020</h1>
<p>Chore/Housekeeping:</p>
<ul>
<li><a href="https://github.com/wycats/handlebars.js/issues/1644">#1644</a> - Download links to aws broken on handlebarsjs.com - access denied (<a href="https://api.github.com/users/Tea56">@Tea56</a>)</li>
<li>Fix spelling and punctuation in changelog - d78cc73</li>
</ul>
<p>Bugfixes:</p>
<ul>
<li>Add Type Definition for Handlebars.VERSION, Fixes #1647 - 4de51fe</li>
...
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.7.2...v4.7.3">Commits</a></p>
<h1><a class="anchor" id="autotoc_md1011"></a>
v4.7.2 - January 13th, 2020</h1>
<p>Bugfixes:</p>
<ul>
<li>fix: don't wrap helpers that are not functions - 9d5aa36, #1639</li>
</ul>
<p>Chore/Build:</p>
<ul>
<li>chore: execute saucelabs-task only if access-key exists - a4fd391</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>No breaking changes are to be expected</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.7.1...v4.7.2">Commits</a></p>
<h1><a class="anchor" id="autotoc_md1012"></a>
v4.7.1 - January 12th, 2020</h1>
<p>Bugfixes:</p>
<ul>
...
v4.7.0 - January 10th, 2020</h1>
<p>Features:</p>
<ul>
<li>feat: default options for controlling proto access - 7af1c12, #1635<ul>
<li>This makes it possible to disable the prototype access restrictions added in 4.6.0</li>
<li>an error is logged in the console, if access to prototype properties is attempted and denied and no explicit configuration has taken place.</li>
</ul>
</li>
</ul>
<p>Compatibility notes:</p>
...
v4.6.0 - January 8th, 2020</h1>
<p>Features:</p>
<ul>
<li>feat: access control to prototype properties via whitelist (#1633)- d03b6ec</li>
</ul>
<p>Bugfixes:</p>
<ul>
<li>fix(runtime.js): partials compile not caching (#1600) - 23d58e7</li>
</ul>
<p>Chores, docs:</p>
<ul>
<li>various refactorings and improvements to tests - d7f0dcf, 187d611, d337f40</li>
<li>modernize the build-setup<ul>
...
<li>chore: try to fix saucelabs credentials (#1627) -</li>
<li>Update readme.md with updated links (#1620) - edcc84f</li>
</ul>
<p>BREAKING CHANGES:</p>
<ul>
<li><p class="startli">access to prototype properties is forbidden completely by default, specific properties or methods can be allowed via runtime-options. See #1633 for details. If you are using Handlebars as documented, you should not be accessing prototype properties from your template anyway, so the changes should not be a problem for you. Only the use of undocumented features can break your build.</p>
<p class="startli">That is why we only bump the minor version despite mentioning breaking changes.</p>
</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.5.3...v4.6.0">Commits</a></p>
<h1><a class="anchor" id="autotoc_md1015"></a>
v4.5.3 - November 18th, 2019</h1>
<p>Bugfixes:</p>
<ul>
...
<li>add chai and dirty-chai and sinon, for cleaner test-assertions and spies, deprecate old assertion-methods - 93e284e, 886ba86, 0817dad, 93516a0</li>
</ul>
<p>Security:</p>
<ul>
<li>The properties <code>__proto__</code>, <code>__defineGetter__</code>, <code>__defineSetter__</code> and <code>__lookupGetter__</code> have been added to the list of "properties that must be enumerable". If a property by that name is found and not enumerable on its parent, it will silently evaluate to <code>undefined</code>. This is done in both the compiled template and the "lookup"-helper. This will prevent new Remote-Code-Execution exploits that have been published recently.</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>Due to the security-fixes. The semantics of the templates using <code>__proto__</code>, <code>__defineGetter__</code>, <code>__defineSetter__</code> and <code>__lookupGetter__</code> in the respect that those expression now return <code>undefined</code> rather than their actual value from the proto.</li>
<li>The semantics have not changed in cases where the properties are enumerable, as in:</li>
</ul>
<div class="fragment"><div class="line">{</div>
<div class="line">  __proto__: &#39;some string&#39;;</div>
<div class="line">}</div>
</div><!-- fragment --><ul>
<li>The change may be breaking in that respect, but we still only increase the patch-version, because the incompatible use-cases are not intended, undocumented and far less important than fixing Remote-Code-Execution exploits on existing systems.</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.5.2...v4.5.3">Commits</a></p>
<h1><a class="anchor" id="autotoc_md1016"></a>
v4.5.2 - November 13th, 2019</h1>
...
<p>Compatibility notes:</p>
<ul>
<li>no incompatibility are to be expected</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.5.1...v4.5.2">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1018"></a>
v4.5.1 - October 29th, 2019</h2>
<p>Bugfixs</p>
<ul>
<li>fix: move "eslint-plugin-compat" to devDependencies - 5e9d17f (#1589)</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>No compatibility issues are to be expected</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.5.0...v4.5.1">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1019"></a>
v4.5.0 - October 28th, 2019</h2>
<p>Features / Improvements</p>
<ul>
<li>Add method Handlebars.parseWithoutProcessing (#1584) - 62ed3c2</li>
<li>add guard to if &amp; unless helpers (#1549)</li>
<li>show source location for the strict lookup exceptions - feb60f8</li>
</ul>
<p>Bugfixes:</p>
<ul>
<li>Use objects for hash value tracking - 7fcf9d2</li>
</ul>
<p>Chore:</p>
<ul>
<li>Resolve deprecation warning message from eslint while running eslint (#1586) - 7052e88</li>
<li>chore: add eslint-plugin-compat and eslint-plugin-es5 - 088e618</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>No compatibility issues are to be expected</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.4.5...v4.5.0">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1020"></a>
v4.4.5 - October 20th, 2019</h2>
<p>Bugfixes:</p>
<ul>
<li>Contents of raw-blocks must be matched with non-eager regex-matching - 8d5530e, #1579</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.4.4...v4.4.5">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1021"></a>
v4.4.4 - October 20th, 2019</h2>
<p>Bugfixes:</p>
<ul>
<li>fix: prevent zero length tokens in raw-blocks (#1577, #1578) - f1752fe</li>
</ul>
<p>Chore:</p>
<ul>
<li>chore: link to s3 bucket with https, add "npm ci" to build instructions - 0b593bf</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>no compatibility issues are expected</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.4.3...v4.4.4">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1022"></a>
v4.4.3 - October 8th, 2019</h2>
<p>Bugfixes</p>
<p>Typings:</p>
<ul>
<li>add missing type fields to AST typings and add tests for them - 0440af2</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.4.2...v4.4.3">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1023"></a>
v4.4.2 - October 2nd, 2019</h2>
<ul>
<li>chore: fix grunt-saucelabs dependency - b7eada0</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.4.1...v4.4.2">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1024"></a>
v4.4.1 - October 2nd, 2019</h2>
<ul>
<li><a href="https://github.com/wycats/handlebars.js/issues/1562">#1562</a> - Error message for syntax error missing location in 4.2.1+</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.4.0...v4.4.1">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1025"></a>
v4.4.0 - September 29th, 2019</h2>
<ul>
<li>Added support for iterable objects in {{#each}} helper (#1557) - cf7545e</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.3.4...v4.4.0">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1026"></a>
v4.3.4 - September 28th, 2019</h2>
<ul>
<li>fix: harden "propertyIsEnumerable"-check - ff4d827</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>No incompatibilities are known.</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.3.3...v4.3.4">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1027"></a>
v4.3.3 - September 27th, 2019</h2>
<ul>
<li>fix test case for browsers that do not support <b>defineGetter</b> - 8742bde</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.3.2...v4.3.3">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1028"></a>
v4.3.2 - September 26th, 2019</h2>
<ul>
<li>Use Object.prototype.propertyIsEnumerable to check for constructors - 213c0bb, #1563</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>There are no breaking changes</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.3.1...v4.3.2">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1029"></a>
v4.3.1 - September 25th, 2019</h2>
<p>Fixes:</p>
<ul>
<li>do not break on precompiled templates from Handlebars &gt;=4.0.0 &lt;4.3.0 - 1266838, #1561</li>
<li>Ensure allowCallsToHelperMissing runtime option is optional in typings - 93444c5, 64ecb9e, #1560</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.3.0...v4.3.1">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1030"></a>
v4.3.0 - September 24th, 2019</h2>
<p>Fixes:</p>
<ul>
<li>Security: Disallow calling "helperMissing" and "blockHelperMissing" directly - 2078c72</li>
<li>Disallow calling "helperMissing" and "blockHelperMissing" directly - 2078c72</li>
</ul>
<p>Features:</p>
<ul>
<li>Add new runtime option <code>allowCallsToHelperMissing</code> to allow calling <code>blockHelperMissing</code> and <code>helperMissing</code>.</li>
</ul>
<p>Breaking changes:</p>
<p>Compatibility notes:</p>
<ul>
<li>Compiler revision increased - 06b7224<ul>
<li>This means that template compiled with versions prior to 4.3.0 will not work with runtimes &gt;= 4.3.0 The increase was done because the "helperMissing" and "blockHelperMissing" are now moved from the helpers to the internal "container.hooks" object, so old templates will not be able to call them anymore. We suggest that you always recompile your templates with the latest compiler in your build pipelines.</li>
</ul>
</li>
<li>Disallow calling "helperMissing" and "blockHelperMissing" directly - 2078c72<ul>
<li>Calling "helperMissing" and "blockHelperMissing" directly from a template (like in <code>{{blockHelperMissing}}</code> was never intended and was part of the exploits that have been revealed early in 2019 (see <a href="https://github.com/wycats/handlebars.js/issues/1495">https://github.com/wycats/handlebars.js/issues/1495</a>). <em>It is also part of a new exploit that is not captured by the earlier fix.</em> In order to harden Handlebars against such exploits, calling thos helpers is now not possible anymore. <em>Overriding</em> those helpers is still possible.</li>
<li>If you really need this behavior, you can set the runtime option <code>allowCallsToHelperMissing</code> to <code>true</code> and the calls will again be possible</li>
</ul>
</li>
</ul>
...
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.2.1...v4.3.0">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1031"></a>
v4.2.1 - September 20th, 2019</h2>
<p>Bugfixes:</p>
<ul>
<li>The "browser" property in the package.json has been updated to use the common-js builds instead of the minified UMD - c55a7be, #1553</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>No compatibility issues should arise</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.2.0...v4.2.1">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1032"></a>
v4.2.0 - September 3rd, 2019</h2>
<p>Chore/Test:</p>
<ul>
<li>Use custom <code>grunt-saucelab</code> with current sauce-connect proxy - f119497</li>
<li>Add framework for various integration tests - f9cce4d</li>
<li>Add integration test for webpack - a57b682</li>
</ul>
<p>Bugfixes:</p>
<ul>
<li><a href="https://github.com/wycats/handlebars.js/issues/1544">#1544</a> - Typescript types: <code>knownHelpers</code> doesnt allow for custom helpers (<a href="https://api.github.com/users/NickCis">@NickCis</a>)</li>
<li><a href="https://github.com/wycats/handlebars.js/pull/1534">#1534</a> - Add typings for "Handlebars.VM.resolvePartial (&lt;a href="<a href="https://api.github.com/users/AndrewLeedham">https://api.github.com/users/AndrewLeedham</a>"&gt;@AndrewLeedham)</li>
</ul>
<p>Features:</p>
<ul>
<li><a href="https://github.com/wycats/handlebars.js/pull/1540">#1540</a> - added "browser"-property to package.json, resolves #1102 (<a href="https://api.github.com/users/ouijan">@ouijan</a>)</li>
</ul>
<p>Compatibility notes:</p>
<ul>
<li>The new "browser"-property should not break anything, but you can never be sure. The integration test for webpack shows that it works, but if it doesn't please open an issue.</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.1.2-0...v4.2.0">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1033"></a>
v4.1.2-0 - August 25th, 2019</h2>
<p><a href="https://github.com/wycats/handlebars.js/pull/1540">#1540</a> - added browser to package.json, resolves #1102 (<a href="https://api.github.com/users/ouijan">@ouijan</a>)</p>
<p>Compatibility notes:</p>
<ul>
<li>We are not sure if imports via webpack are still working, which is why this release is a pre-release</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.1.2...v4.1.2-0">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1034"></a>
v4.1.2 - April 13th, 2019</h2>
<p>Chore/Test:</p>
<ul>
...
<p>Compatibility notes:</p>
<p>Access to the constructor of a class thought <code>{{lookup obj "constructor" }}</code> is now prohibited. This closes a leak that only half closed in versions 4.0.13 and 4.1.0, but it is a slight incompatibility.</p>
<p>This kind of access is not the intended use of Handlebars and leads to the vulnerability described in #1495. We will <b>not</b> increase the major version, because such use is not intended or documented, and because of the potential impact of the issue (we fear that most people won't use a new major version and the issue may not be resolved on many systems).</p>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.1.1...v4.1.2">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1035"></a>
v4.1.1 - March 16th, 2019</h2>
<p>Bugfixes:</p>
<ul>
...
<p>Compatibility notes:</p>
<p>Access to class constructors (i.e. <code>({}).constructor</code>) is now prohibited to prevent Remote Code Execution. This means that following construct will no work anymore:</p>
<div class="fragment"><div class="line">class SomeClass {</div>
<div class="line">}</div>
<div class="line"> </div>
<div class="line">SomeClass.staticProperty = &#39;static&#39;</div>
<div class="line"> </div>
<div class="line">var template = Handlebars.compile(&#39;{{constructor.staticProperty}}&#39;);</div>
<div class="line">document.getElementById(&#39;output&#39;).innerHTML = template(new SomeClass());</div>
<div class="line">// expected: &#39;static&#39;, but now this is empty.</div>
</div><!-- fragment --><p>This kind of access is not the intended use of Handlebars and leads to the vulnerability described in #1495. We will <b>not</b> increase the major version, because such use is not intended or documented, and because of the potential impact of the issue (we fear that most people won't use a new major version and the issue may not be resolved on many systems).</p>
<p><a href="https://github.com/wycats/handlebars.js/compare/v4.0.12...v4.1.0">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1037"></a>
v4.0.12 - September 4th, 2018</h2>
<p>New features:</p>
<ul>
<li>none</li>
</ul>
...
<li><a href="https://github.com/wycats/handlebars.js/issues/805">#805</a> - Request: "strict" lookups (<a href="https://github.com/nzakas">@nzakas</a>)</li>
<li>Export the default object for handlebars/runtime - 5594416</li>
...
v2.0.0-beta.1 - August 26th, 2014</h2>
<ul>
...
<li><a href="https://github.com/wycats/handlebars.js/issues/835">#835</a> - Templates overwritten if file is loaded twice</li>
<li>Expose escapeExpression on the root object - 980c38c</li>
...
<li>Numerious methods/features removed from pseudo-API classes<ul>
...
v2.0.0-alpha.4 - May 19th, 2014</h2>
<ul>
...
v2.0.0-alpha.3 - May 19th, 2014</h2>
<ul>
...
v2.0.0-alpha.2 - March 6th, 2014</h2>
<ul>
...
v2.0.0-alpha.1 - February 10th, 2014</h2>
<ul>
...
<li><a href="https://github.com/wycats/handlebars.js/pull/729">#729</a> - Convert template spec to object literal (<a href="https://github.com/kpdecker">@kpdecker</a>)</li>
<li><a href="https://github.com/wycats/handlebars.js/issues/658">#658</a> - Depthed helpers do not work after an upgrade from 1.0.0 (<a href="https://github.com/xibxor">@xibxor</a>)</li>
...
<li><a href="https://github.com/wycats/handlebars.js/pull/706">#706</a> - README: Use with helper instead of relying on blockHelperMissing (<a href="https://github.com/scottgonzalez">@scottgonzalez</a>)</li>
<li><a href="https://github.com/wycats/handlebars.js/pull/700">#700</a> - Remove redundant conditions (<a href="https://github.com/blakeembrey">@blakeembrey</a>)</li>
...
<li>Browserify users may link to the runtime library via &lsquo;require('handlebars/runtime&rsquo;)`</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v1.1.2...v1.2.0">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1063"></a>
v1.1.2 - November 5th, 2013</h2>
<ul>
...
<li><a href="https://github.com/wycats/handlebars.js/issues/644">#644</a> - Using precompiled templates (AMD mode) with handlebars.runtime 1.1.1 (<a href="https://github.com/fddima">@fddima</a>)</li>
<li>Add simple binary utility tests - 96a45a4</li>
...
v1.1.1 - November 4th, 2013</h2>
<ul>
<li><a href="https://github.com/wycats/handlebars.js/issues/642">#642</a> - handlebars 1.1.0 are broken with nodejs</li>
<li>Fix release notes link - 17ba258</li>
</ul>
<p><a href="https://github.com/wycats/handlebars.js/compare/v1.1.0...v1.1.1">Commits</a></p>
<h2><a class="anchor" id="autotoc_md1065"></a>
v1.1.0 - November 3rd, 2013</h2>
<ul>
...
<li><a href="https://github.com/wycats/handlebars.js/pull/543">#543</a> - publish passing master builds to s3 (<a href="https://github.com/fivetanley">@fivetanley</a>)</li>
<li><a href="https://github.com/wycats/handlebars.js/issues/608">#608</a> - Add <code>includeZero</code> flag to <code>if</code> conditional</li>
...
<p>Compatibility notes:</p>
<ul>
<li>The parser is now stricter on <code>{{{</code>, requiring that the end token be <code>}}}</code>. Templates that do not follow this convention should add the additional brace value.</li>
...
v1.0.11 / 1.0.0-rc4 - May 13 2013</h2>
<ul>
...
<li><a href="https://github.com/wycats/handlebars.js/issues/460">#460</a> - Allow <code>:</code> in unescaped identifiers (<a href="https://github.com/jpfiset">@jpfiset</a>)</li>
...
1.0.0-rc3 - Browser - Feb 14 2013</h2>
<ul>
...
Prior Versions</h2>
<p>When upgrading from the Handlebars 0.9 series, be aware that the signature for passing custom helpers or partials to templates has changed.</p>
<p>Instead of:</p>
<div class="fragment"><div class="line">template(context, helpers, partials, [data]);</div>
</div><!-- fragment --><p>Use:</p>
<div class="fragment"><div class="line">template(context, { helpers: helpers, partials: partials, data: data });</div>
